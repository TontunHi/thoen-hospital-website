...
export default function ServiceError({
  ...
  useEffect(() => {
    console.error('Service module error:', error.message)
  }, [error])
    ...
    <div style={{
      ...
      <div style={{
        ...
        <h2 style={{ fontSize: '1.25rem', fontWeight: '700', color: '#0f172a', margin: '0 0 0.5rem 0' }}>
          ไม่สามารถโหลดข้อมูลบริการทางการแพทย์ได้
        </h2>

        <p style={{ fontSize: '0.9rem', color: '#64748b', lineHeight: '1.5', margin: '0 0 1.25rem 0' }}>
          การเชื่อมต่อกับระบบสารสนเทศโรงพยาบาล (HOSxP) ขัดข้องชั่วคราว หรือหมดเวลาการเชื่อมต่อ กรุณากดลองใหม่อีกครั้ง
        </p>
