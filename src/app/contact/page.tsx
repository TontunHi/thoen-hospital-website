    ...
    <div className="container contactPage">
      ...
      <div className="contactGrid">
          ...
          <div className="infoCard card">
            ...
            <div className="infoItems">
              <div className="infoItem">
                <Phone className="infoIcon text-primary" size={20} />
                <div>
              ...
              <div className="infoItem">
                <Printer className="infoIcon text-primary" size={20} />
                <div>
              ...
              <div className="infoItem">
                <Clock className="infoIcon text-primary" size={20} />
                <div>
                  <strong>เวลาทำการ:</strong>
                  <p>เปิดให้บริการทุกวัน ตลอด 24 ชั่วโมง (แผนกอุบัติเหตุและฉุกเฉิน)</p>
                  <p style={{ marginTop: '0.25rem' }}>แผนกผู้ป่วยนอก (OPD): วันจันทร์ - ศุกร์ เวลา 08.00 น. - 16.00 น.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="contactFormSection card">
          <div className="card-header-with-icon">
            <MessageSquare className="text-primary" size={24} style={{ color: 'var(--accent-gold)' }} />
      ...
      {/* Social & Maps Section */}
      <div className="socialMapGrid" style={{ marginTop: '3.5rem' }}>
