...
export default function SalaryError({
  ...
  useEffect(() => {
    console.error('Salary portal error:', error.message)
  }, [error])
    ...
    <div style={{
      ...
      <div style={{
        ...
        <h2 style={{ fontSize: '1.25rem', fontWeight: '700', color: '#0f172a', margin: '0 0 0.5rem 0' }}>
          ไม่สามารถโหลดข้อมูลสลิปเงินเดือนได้
        </h2>

        <p style={{ fontSize: '0.9rem', color: '#64748b', lineHeight: '1.5', margin: '0 0 1.25rem 0' }}>
          เกิดข้อผิดพลาดในการเชื่อมต่อกับฐานข้อมูลระบบเงินเดือน หรือเซสชันหมดอายุ กรุณาเข้าสู่ระบบใหม่อีกครั้ง
        </p>
