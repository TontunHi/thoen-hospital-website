...
export default function HospitalHistoryPage() {
  const timelineEvents = [
    {
      year: 'พ.ศ. ๒๕๓๕',
      text: 'โรงพยาบาลเถินเริ่มก่อสร้าง มีข้าราชการจำนวน ๒ คน โดยใช้เรือนจ่ายยาของสถานีอนามัยทำการตรวจรักษาคนไข้เบื้องต้น'
    },
    {
      year: 'พ.ศ. ๒๕๓๖',
    ...
    {
      year: 'พ.ศ. ๒๕๓๘',
      text: 'ดำเนินการก่อสร้างอาคารผู้ป่วยนอก (OPD) และอาคารหลักสำเร็จเสร็จสิ้น ณ บ้านแม่แก้ว หมู่ที่ ๔ ตำบลล้อมแรด อำเภอเถิน'
    },
    {
      year: 'พ.ศ. ๒๕๔๐',
      text: 'ร่วมประชุมวางแผนงานเชิงนโยบายและจัดสรรงบประมาณจากการร่วมบริจาคของประชาชนในพื้นที่ เพื่อขยายศักยภาพความเป็นโรงพยาบาลในเขตหมู่ที่ ๙ ตำบลล้อมแรด'
    },
    {
      year: 'ปัจจุบัน',
      text: 'โรงพยาบาลเถินเป็นโรงพยาบาลชุมชนระดับทุติยภูมิขนาด ๙๐ เตียง มุ่งพัฒนาบริการและดูแลรักษาผู้ป่วยในพื้นที่อำเภอเถิน จังหวัดลำปาง'
    }
  ]
        ...
        <section className="serviceSection card">
          <div className="serviceGrid">
            ...
            <div className="serviceContent">
              ...
              <p>
                โรงพยาบาลเถินดำเนินภารกิจด้านการให้บริการส่งเสริมสุขภาพ การป้องกันโรค การรักษาพยาบาล และการฟื้นฟูสมรรถภาพ โดยเน้นระบบบริการสุขภาพปฐมภูมิ ให้บริการตลอด ๒๔ ชั่วโมงในปฏิบัติการฉุกเฉิน
              </p>
              <p>
        ...
        <section className="areasSection">
          <div className="areasGrid">
            <div className="areaInfoCard card">
              ...
              <p>
                เป็นพื้นที่ของโรงพยาบาลชุมชนขนาด ๙๐ เตียง แต่งตั้งโรงพยาบาลชุมชนเป็นหน่วยงานหลัก ดูแลประชาชนในพื้นที่รับผิดชอบ ผู้มีสิทธิทุกระบบตามที่กฎหมายกำหนด
              </p>
              <p>
                มีระบบการบริหารการจัดการและสนับสนุนด้านสุขภาพในพื้นที่อย่างทั่วถึงตามนโยบายสาธารณสุข การบริการสุขภาพเชิงรุกต่อเนื่อง โดยมีการดำเนินงานในเขตเครือข่ายบริการ ๘๖,๐๐๐ คน แยกเป็นเด็กเล็ก เด็กวัยเรียน วัยทำงาน ผู้สูงอายุ และผู้ป่วย ครอบคลุมพื้นที่อำเภอเถิน อำเภอแม่พริก และอำเภอใกล้เคียง
              </p>
            </div>
